...
type PreindexTimezones struct {
	...
	PreindexIdxZoom int32               `protobuf:"varint,1,opt,name=preindex_idx_zoom,json=preindexIdxZoom,proto3" json:"preindex_idx_zoom,omitempty"` // which zoom value the tiles generated
	PreindexAggZoom int32               `protobuf:"varint,2,opt,name=preindex_agg_zoom,json=preindexAggZoom,proto3" json:"preindex_agg_zoom,omitempty"` // which zoom value the tiles merge up with.
...
func (x *PreindexTimezones) GetPreindexIdxZoom() int32 {
	if x != nil {
		return x.PreindexIdxZoom
	}
	return 0
}

func (x *PreindexTimezones) GetPreindexAggZoom() int32 {
	if x != nil {
		return x.PreindexAggZoom
	}
	return 0
}
...
type PreindexBitmapsItem struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *PreindexBitmapsItem) Reset() {
	*x = PreindexBitmapsItem{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pb_tzinfo_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *PreindexBitmapsItem) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PreindexBitmapsItem) ProtoMessage() {}

func (x *PreindexBitmapsItem) ProtoReflect() protoreflect.Message {
	mi := &file_pb_tzinfo_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PreindexBitmapsItem.ProtoReflect.Descriptor instead.
func (*PreindexBitmapsItem) Descriptor() ([]byte, []int) {
	return file_pb_tzinfo_proto_rawDescGZIP(), []int{9}
}

func (x *PreindexBitmapsItem) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *PreindexBitmapsItem) GetData() []byte {
	if x != nil {
		return x.Data
	}
	return nil
...
type PreindexBitmaps struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	BitmapIdxZoom int32                  `protobuf:"varint,1,opt,name=bitmap_idx_zoom,json=bitmapIdxZoom,proto3" json:"bitmap_idx_zoom,omitempty"` // which zoom value the tiles generated
	BitmapAggZoom int32                  `protobuf:"varint,2,opt,name=bitmap_agg_zoom,json=bitmapAggZoom,proto3" json:"bitmap_agg_zoom,omitempty"` // which zoom value the tiles merge up with.
	Items         []*PreindexBitmapsItem `protobuf:"bytes,3,rep,name=items,proto3" json:"items,omitempty"`
	Version       string                 `protobuf:"bytes,4,opt,name=version,proto3" json:"version,omitempty"`
}

func (x *PreindexBitmaps) Reset() {
	*x = PreindexBitmaps{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pb_tzinfo_proto_msgTypes[10]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *PreindexBitmaps) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PreindexBitmaps) ProtoMessage() {}

func (x *PreindexBitmaps) ProtoReflect() protoreflect.Message {
	mi := &file_pb_tzinfo_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PreindexBitmaps.ProtoReflect.Descriptor instead.
func (*PreindexBitmaps) Descriptor() ([]byte, []int) {
	return file_pb_tzinfo_proto_rawDescGZIP(), []int{10}
}

func (x *PreindexBitmaps) GetBitmapIdxZoom() int32 {
	if x != nil {
		return x.BitmapIdxZoom
	}
	return 0
}

func (x *PreindexBitmaps) GetBitmapAggZoom() int32 {
	if x != nil {
		return x.BitmapAggZoom
	}
	return 0
}

func (x *PreindexBitmaps) GetItems() []*PreindexBitmapsItem {
	if x != nil {
		return x.Items
	}
	return nil
...
func (x *PreindexBitmaps) GetVersion() string {
	if x != nil {
		return x.Version
	}
	return ""
...
var file_pb_tzinfo_proto_rawDesc = []byte{
	...
	,
	...
	,
...
var file_pb_tzinfo_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_pb_tzinfo_proto_goTypes = []interface{}{
	...
	(*PreindexBitmapsItem)(nil), // 10: pb.PreindexBitmapsItem
	(*PreindexBitmaps)(nil),     // 11: pb.PreindexBitmaps
}
var file_pb_tzinfo_proto_depIdxs = []int32{
	...
	10, // 9: pb.PreindexBitmaps.items:type_name -> pb.PreindexBitmapsItem
...
func file_pb_tzinfo_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pb_tzinfo_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PreindexBitmapsItem); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_pb_tzinfo_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PreindexBitmaps); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
